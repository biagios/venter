...
const config = {
	...
	admins: [process.env.ADMIN_ID_1],

	// Bot Support, level 8 by default. Array of user ID strings
	support: [process.env.SUPPORT_ID_1],

	// Your Bot's Token.
	token: process.env.DISCORD_TOKEN,

	// Vents Hook details.
	venterhook: [process.env.VENTER_HOOK_ID, process.env.VENTER_HOOK_TOKEN],

	// Reveal Vents Hook details.
	revealerhook: [process.env.REVEALER_HOOK_ID, process.env.REVEALER_HOOK_TOKEN],

	// Logs Hook details.
	logshook: [process.env.LOGS_HOOK_ID, process.env.LOGS_HOOK_TOKEN],
